...
class AllTimeLead extends StatefulWidget {
  const AllTimeLead({Key? key}) : super(key: key);

  @override
  State<AllTimeLead> createState() => _AllTimeLeadState();
}

class _AllTimeLeadState extends State<AllTimeLead> {
  bool isEmpty = false;
  ...
  Future<List> fetchAllTimeRank() async {
    ...
    await rankProviders.fetchAllTimeRanks();
    final List<RankingModel> allTimeRanks = rankProviders.getalltimeRanks;
